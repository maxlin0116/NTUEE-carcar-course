...
// 18    TX       ->  RX
// 19    RX       <-  TX
// TB6612, 隢??扯撌梯?銝??亦?撖怠?喃?(撌血銝?摰?頝酉閫?神??璅?
#define MotorR_I1 6     // 摰儔 A1 ?亥嚗嚗?
#define MotorR_I2 7     // 摰儔 A2 ?亥嚗嚗?
#define MotorR_PWMR 11  // 摰儔 ENA (PWM隤輸? ?亥
#define MotorL_I3 8     // 摰儔 B1 ?亥嚗椰嚗?
#define MotorL_I4 9     // 摰儔 B2 ?亥嚗椰嚗?
#define MotorL_PWML 10  // 摰儔 ENB (PWM隤輸? ?亥
// 敺芰?璅∠?, 隢??扯撌梯?銝??亦?撖怠?喃?
#define IRpin_LL A7
#define IRpin_L A6
#define IRpin_M A5
#define IRpin_R A4
#define IRpin_RR A3
// RFID, 隢??扯撌梯?銝??亦?撖怠?喃?
#define RST_PIN 3                 // 霈?⊥???蝵株雿?
#define SS_PIN 2                  // ?嗥??豢??喃?
MFRC522 mfrc522(SS_PIN, RST_PIN);  // 撱箇?MFRC522?拐辣
// BT
...
int l2 = 0, l1 = 0, m0 = 0, r1 = 0, r2 = 0;  // 蝝?蝺芋蝯?霈??0->white,1->black)
